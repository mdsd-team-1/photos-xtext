 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ReactImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ReactImpl#getReacts <em>Reacts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReactImpl extends MinimalEObjectImpl.Container implements React
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.REACT__NAME, oldName, name));
  }
  ...
  public EList<ReactModules> getReacts()
  {
    if (reacts == null)
    {
      reacts = new EObjectContainmentEList<ReactModules>(ReactModules.class, this, MyDslPackage.REACT__REACTS);
    }
    return reacts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.REACT__REACTS:
